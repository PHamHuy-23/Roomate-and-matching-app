...
class AdminPostNeedsEditScreen extends StatelessWidget {
  const AdminPostNeedsEditScreen({super.key});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Lý do: Cần bổ sung ảnh phòng đúng thực tế.\nNgười đăng có thể cập nhật thông tin và gửi lại.',
                            style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'SourceSansPro',
